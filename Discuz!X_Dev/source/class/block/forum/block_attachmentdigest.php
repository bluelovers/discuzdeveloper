...
class block_attachmentdigest extends block_attachment {
	function block_attachmentdigest() {
		$this->settings = array(
			'fids'	=> array(
	...
	function name() {
		return lang('blockclass', 'blockclass_attachment_script_attachmentdigest');
	}
