...
class magic_stick {
	...
	function usesubmit() {
		...
		updatemagicthreadlog($_G['gp_tid'], $this->magic['magicid'], $expiration > 0 ? 'EST' : 'STK', $expiration);
		...
		showmessage(lang('magic/stick', 'stick_succeed'), dreferer(), array(), array('showdialog' => 1, 'locationtime' => true));
	}
