...
class ManyouHelper {
	...
	function getMethodCode($module, $method) {
		$methods = array(
				'Users.getInfo' => 1,
				'Users.getFriendInfo' => 2,
				'Users.getExtraInfo' => 3,
				'Friends.get' => 4,
				'Friends.areFriends' => 5,
				'UserApplication.add' => 6,
				'UserApplication.remove' => 7,
				'UserApplication.update' => 8,
				'UserApplication.getInstalled' => 9,
				'UserApplication.get' => 10,
				'Site.getUpdatedUsers' => 11,
				'Site.getUpdatedFriends' => 12,
				'Site.getAllUsers' => 13,
				'Site.getStat' => 14,
				'Feed.publishTemplatizedAction' => 15,
				'Notifications.send' => 16,
				'Notifications.get' => 17,
				'Application.update' => 18,
				'Application.remove' => 19,
				'Application.setFlag' => 20,
				'Profile.setMYML' => 21,
				'Profile.setActionLink' => 22,
				'Credit.get' => 23,
				'Credit.update' => 24,
				'Request.send' => 25,
				'VideoAuth.setAuthStatus' => 26,
				'VideoAuth.auth' => 27,
				'MiniBlog.post' => 28,
				'MiniBlog.get' => 29,
				'Photo.createAlbum' => 30,
				'Photo.updateAlbum' => 31,
				'Photo.removeAlbum' => 32,
				'Photo.getAlbums' => 33,
				'Photo.upload' => 34,
				'Photo.get' => 35,
				'Photo.update' => 36,
				'Photo.remove' => 37,
				'NewsFeed.get' => 38,
				'ImbotMsn.setBindStatus' => 39,
				'Search.getUserGroupPermissions' => 40,
				'Search.getUpdatedPosts' => 41,
				'Search.removePostLogs' => 42,
				'Search.getPosts' => 43,
				'Search.getNewPosts' => 44,
				'Search.getAllPosts' => 45,
				'Search.removePosts' => 46,
				'Search.getUpdatedThreads' => 47,
				'Search.removeThreadLogs' => 48,
				'Search.getThreads' => 49,
				'Search.getNewThreads' => 50,
				'Search.getAllThreads' => 51,
				'Search.getForums' => 52,
				'Common.setConfig' => 53,
				'Common.getNav' => 54,
				);
...
class Cloud_Client {
	...
	static function _buildArrayQuery($data, $key = '', $isEncode = false) {
...
class Discuz_Cloud_Client {
	...
	function connectSync() {
		...
		$data = $this->Client->connectSync($connectData['like_qq'], $connectData['turl_qq']);
