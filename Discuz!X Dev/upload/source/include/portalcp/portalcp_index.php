...
if($op == 'list' && !checkperm('allowmanagearticle') && !$admincp2 && !$admincp3) {
...
function showcategoryrow($key, $level = 0, $last = '') {
	...
	if ((checkperm('allowmanagearticle') || $permission[$key]['allowmanage'] || checkperm('allpublish') || $permission[$key]['allowpublish']) && empty($value['disallowpublish'])) {
...
function showcategoryrowpush($key, $level = 0, $last = '') {
	...
	$op = '';
	if (checkperm('allowmanagearticle') || checkperm('allpublish') || $permission[$key]['allowpublish'] || $permission[$key]['allowmanage']) {
