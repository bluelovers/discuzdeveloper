...
if($catid) {
	if (!$allowmanage && empty($permission[$catid]['allowmanage']) && empty($permission[$catid]['allowpublish'])) {
...
if($count) {
	...
	while ($value = DB::fetch($query)) {
		...
		$value['allowpublish'] = ($value['allowmanage'] || !empty($permission[$value['catid']]['allowpublish'])) ? true : false;
		$value['taghtml'] = '';
