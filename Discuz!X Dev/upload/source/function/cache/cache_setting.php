...
function get_cachedata_setting_plugin($method = '') {
	...
	$data['plugins']['hookscript_common'] = $data['plugins']['hookscript_discuzcode'] = false;
	$data['plugins']['hookscriptmobile_common'] = $data['plugins']['hookscriptmobile_discuzcode'] = false;
