		...
		$this->setting = array(
			...
			'orderby' => array(
				...
				'value' => array(
					...
					array('hourviews', 'sortlist_orderby_hourviews'),
					array('todayviews', 'sortlist_orderby_todayviews'),
					array('weekviews', 'sortlist_orderby_weekviews'),
					array('monthviews', 'sortlist_orderby_monthviews'),
				),
				'default' => 'lastpost'
			),
			'hours' => array(
				'title' => 'sortlist_orderby_hours',
				'type' => 'text'
			),
			'startrow' => array(
